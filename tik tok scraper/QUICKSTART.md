...
## Step 2: Setup Supabase Database (2–3 minutes)

1. Go to https://supabase.com and sign up (free)
2. Create a new project
3. Go to **SQL Editor** → **New Query**
4. Run the base schema:
   - Copy/paste content from `migrations/002_create_tiktok_table.sql`
   - Click **Run**
5. Add trend lifecycle indexes (for first_seen/peak/decay analytics):
   - Copy/paste content from `migrations/003_add_trend_lifecycle_tracking.sql`
   - Click **Run**
6. Add language detection columns & indexes:
   - Copy/paste content from `migrations/004_add_language_detection.sql`
   - Click **Run**
7. (Optional but recommended) Disable Row Level Security for quick testing:
   ```sql
